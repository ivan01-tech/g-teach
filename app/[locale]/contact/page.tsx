          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-muted-foreground">
                {t("Have a question, suggestion, or partnership inquiry? We'd love to hear from you. Our team typically responds within 24 hours.")}
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              <div>
                ...
                {submitted ? (
                  <div className="mt-8 rounded-lg border border-accent bg-accent/10 p-8 text-center">
                    ...
                    <p className="mt-2 text-muted-foreground">
                      {t("Thank you for contacting us. We'll respond to your inquiry within 24 hours.")}
                    </p>
                    <Button
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  {t("Choose the best way to get in touch based on your needs.")}
                </p>
                ...
                <div className="mt-8 rounded-lg border border-border bg-muted/50 p-6">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    {t("Before reaching out, you might find your answer in our FAQ section.")}
                  </p>
                  <Button variant="outline" className="mt-4 bg-transparent" asChild>
                    <a href="/faq">{t("View FAQ")}</a>
                  </Button>
                </div>
              </div>
            </div>
